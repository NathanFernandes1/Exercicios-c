...
int ordenarStruct(TFuncionario vet[],TFuncionario vetAux[], int quant,char genero);
int main ()
{
	//declaração de variáveis
	TFuncionario vetor[7],vetorAuxiliar[7];
	int quantidade = 7;
	char genero;
	...
	ordenarStruct(vetor,vetorAuxiliar,quantidade,genero);
	exibirPessoas (vetor, quantidade);
